function AdsLook(props) {
    ...
    return (
        ...
        <div className="card border-0 m-3 shadow">
            ...
            <div className="border border-1 fw-lighter text bg-light rounded-3 col-6 m-2 p-1">ID: {data.id}</div>
            <div className="card-body ">
                ...
                <div><i className="bi bi-telephone"></i>: {data.phone}</div>
                <div>
